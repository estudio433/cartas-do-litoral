        ...
        <div className="rotate-2 opacity-70">
          <div className="border-[1.5px] border-dashed border-accent-warm/40 p-1 bg-secondary inline-block">
            <div className="border border-accent-warm/30 px-2 py-1 flex flex-col items-center gap-0.5">
              ...
              <span className="text-[6px] font-sans tracking-[0.2em] text-accent-warm/80 font-bold">
                FLORIPA 2026
              </span>
            </div>
          </div>
          ...
          {formState === "success" ? (
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Você está na lista. Mel vai escrever para você em breve —
                primeiro por email, depois num envelope de verdade.
              </p>
            ...
            <>
              <div className="space-y-4">
                <p className="text-xs uppercase tracking-widest text-accent-warm/70
                  font-semibold">
                  Você acabou de conhecer a história da Mel
                </p>
                <h1 className="font-serif text-4xl text-foreground leading-tight">
                  Reserve o seu lugar na lista de espera.
                </h1>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ainda estamos em pré-lançamento. Deixe o seu contato e
                  você será das primeiras a saber quando as cartas começarem
                  a viajar.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground/50 text-center
                  ...
                  Escrevemos a cada duas semanas — nunca mais do que isso.
                </p>
              </form>
