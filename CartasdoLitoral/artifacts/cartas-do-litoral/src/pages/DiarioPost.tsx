      ...
      <div className="max-w-[680px] mx-auto">
        ...
        >
          ...
          <div className="text-center">
            ...
            <h1 className="font-serif text-4xl md:text-5xl/tight text-foreground mb-8">
              {post.title}
            </h1>
        ...
        <motion.div
          ...
          className="relative"
        >
          {/* Decorative subtle divider at the top */}
          ...
          <div className="mt-20 p-8 bg-secondary rounded-sm text-center">
            <p className="font-handwritten text-2xl text-foreground mb-4">
              Gostou de receber esta carta?
            </p>
            <p className="text-sm text-muted-foreground mb-6">
              Junte-se à correspondência e receba uma nova história na sua caixa de correio todo mês.
            </p>
            <Link href="/">
